...
def callback_handler(call):
    ...
    if call.message.reply_markup:
        # Не можем точно определить, но в чатах кнопки общие
        # Поэтому просто предупреждаем, если нажал не тот, кто создал
        pass
    
    # В групповых чатах кнопки может нажимать кто угодно
    # Поэтому добавляем проверку в начале каждого действия
...
if __name__ == "__main__":
    ...
    print("✅ Защита от чужих кнопок: 'Это не твои кнопки 🤬'")
