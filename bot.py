...
sell TSLA 2 — продать
    ...
    # Убираем reply_markup=None чтобы скрыть клавиатуру
...
📋 Портфель:
        ...
        text = "🎟️ Введи промокод командой /promo КОД"
        bot.edit_message_text(
            text,
            call.message.chat.id,
            call.message.message_id,
...
def trade_command(message):
    ...
    try:
        ...
        bot.send_message(message.chat.id, "Формат: buy AAPL 5 или sell TSLA 2", reply_markup=get_main_inline_keyboard())
...
if __name__ == "__main__":
    print("🤖 Terminal Trader с inline кнопками запущен...")
